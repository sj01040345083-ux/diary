...
// 로그인한 사용자가 볼 화면: 홈 / 일기 작성
type Screen = 'home' | 'write'
...
export default function App() {
  ...
  // 로그인된 사용자만 홈/작성 화면(보호된 화면)에 접근할 수 있습니다.
  if (session) {
    return screen === 'write' ? (
      <WritePage
        session={session}
      ...
      <HomePage session={session} onWrite={() => setScreen('write')} />
    )
  }
